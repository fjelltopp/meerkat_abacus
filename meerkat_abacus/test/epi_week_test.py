...
from util import epi_week_start_date
...
class EpiWeekTest(unittest.TestCase):
    def test_epi_year_start_for_international_config(self):
        ...
        self.assertEqual(first_day_of_year, epi_week_start_date(2015, "international"))
    ...
    def test_epi_year_start_for_custom_weekday(self):
        ...
        for weekday, expected_epi_start_datetime in enumerate(first_weekdays_in_year_datetimes):
            epi_config = "day:{!r}".format(weekday)
            actual_epi_start_datetime = epi_week_start_date(year, epi_config)
            self.assertEqual(expected_epi_start_datetime, actual_epi_start_datetime)
    ...
    def test_epi_year_start_for_custom_start_date(self):
        ...
        for year in epi_config:
            ...
            actual_datetime = epi_week_start_date(year, epi_config)
